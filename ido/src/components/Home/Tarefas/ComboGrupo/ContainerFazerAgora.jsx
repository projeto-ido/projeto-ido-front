...
export default function ContainerFazerAgora({ setOpenModalVerTarefa, tarefasAtualizadas, setTarefasAtualizadas }) {
    ...
    return (
        <div>
            <div id="grupoFazerAgora" className={style.div_grupo}>
